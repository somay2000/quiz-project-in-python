...
def rules():
	print('''\n==========RULES==========
1. Each round consists of 15 random questions. To answer, you must press A/B/C/D (case-insensitive).
...
def about():
	print('''\n==========ABOUT US==========
This project has been created by somay mangla and his team.
